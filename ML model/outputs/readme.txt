...
python ml_model.py   --input fevercast360_sample_dataset.csv   --models_dir models   --output_dir outputs   --region_col Region   --label_outbreak outbreak_label   --label_type fever_type   --threshold 0.5
